...
class AppTheme {
  ...
  static ThemeData _baseTheme(
    ...
    return ThemeData(
      brightness: brightness,
      unselectedWidgetColor: const Color(0xFF7972E6),
      iconTheme: IconThemeData(color: textColor),
      scaffoldBackgroundColor: Colors.white,
      primaryColor: const Color(0xFF7972E6),
      fontFamily: 'Poppins',
      disabledColor: Colors.grey,
      appBarTheme: AppBarTheme(
        elevation: _defaultElevation,
        systemOverlayStyle: systemUiOverlayStyle,
        color: const Color(0xFF7972E6),
        iconTheme: IconThemeData(color: textColor),
      ...
      colorScheme: defaultColorScheme.copyWith(
        ...
        onSecondaryContainer: Color.fromARGB(255, 133, 133, 133),
        // primary: accentColor,
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF7972E6))),
  ...
  static final lightTheme = _baseTheme(
    Brightness.light,
    accentColor: const Color(0xFF7972E6),
    textColor: Colors.white,
