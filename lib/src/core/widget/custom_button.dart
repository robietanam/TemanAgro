...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({
    ...
    this.onPressed,
    this.titleStyle,
    this.backgroundColor = const Color(0xFF7972E6),
    this.shape,
    this.width = 140,
    this.height = 50,
    this.loading = false,
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      color: isDisabled ? Color(0xFF7972E6).withOpacity(.6) : backgroundColor,
      shape: _shape,
      elevation: elevation,
      shadowColor: Color(0xFF7972E6),
      child: InkWell(
        ...
        child: ConstrainedBox(
          ...
          child: Ink(
              decoration: ShapeDecoration(
                shape: _shape,
                color: isDisabled
                    ? Color(0xFF7972E6).withOpacity(.6)
                    : backgroundColor,
              ),
              child: loading
                  ? const Center(
