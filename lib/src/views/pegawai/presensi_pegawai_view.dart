import 'package:com.ppl.teman_agro_admin/src/features/data/data_source/data_pegawai_source.dart';
...
class DetailPresensiPegawaiPage extends ConsumerStatefulWidget {
  const DetailPresensiPegawaiPage(
      {Key? key, required User user, required Map<String, dynamic> pegawaiData})
      : _user = user,
  ...
  @override
  ConsumerState<DetailPresensiPegawaiPage> createState() =>
...
class _DetailPresensiPegawaiState
    extends ConsumerState<DetailPresensiPegawaiPage> {
  late User _user;
